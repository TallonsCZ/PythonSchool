...
if __name__ == '__main__':
  parser = argp.ArgumentParser(description='App to detect Faces')
  parser.add_argument("-p", "--picture", action="store", dest="picture", default="detect.jpg")
  arguments = parser.parse_args()
  detectFaces(arguments.picture)